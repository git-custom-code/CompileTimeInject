namespace CustomCode.CompileTimeInject.ContainerGenerator
{
    ...
    public sealed class ScopeSyntaxReceiver : ISyntaxReceiver
    {
        ...
        /// <summary>
        /// True if the current <see cref="Compilation"/> defines an exported service with
        /// <see cref="Lifetime.Scoped"/>, false otherwise.
        /// </summary>
        public bool UseLifetimeScoped { get; private set; } = false;
